...
default["monit"]["web_interface"] = {
  ...
  encrypted_credentials_data_bag: "passwords",
  enable:  true,
  port:    2812,
  address: "0.0.0.0",
  allow:   ["0.0.0.0/0.0.0.0", nil]
}
...
default["monit"]["mail"] = {
  ...
  username: nil,
  password: nil,
  encrypted_credentials: "email",
  encrypted_credentials_data_bag: "passwords",
  from:     "monit@swapslider.com",
  subject:  "$SERVICE $EVENT at $DATE",
  message:  "Monit $ACTION $SERVICE at $DATE on $HOST,\n\n$DESCRIPTION\n\nDutifully,\nMonit",
  security: 'SSLV3',  # 'SSLV2'|'SSLV3'|'TLSV1'
  timeout:  30,
  using_hostname: nil
}
...
default["monit"]["binary_install"] = true
